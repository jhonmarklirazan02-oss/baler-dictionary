...
function AddWordModal({ isOpen, onClose, onWordAdded, token }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({
        ...
        wordType: [],
        exampleSentence: '',
        verbForms: { present: '', past: '' },
        adjectiveForms: { descriptive: '', demonstrative: '', quantitative: '' },
        nounForms: { singular: '', plural: '' }
      });
      setAudioFile(null);
      setUploadError('');
      onWordAdded();
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Detailed explanation of the word..."
              rows="2"
            />
          </div>
          ...
          <div>
            ...
            {recordingMode === 'upload' ? (
              <div>
                ...
                {}
                <div>
                  <p className="text-themed-muted text-xs mb-2">Or enter existing audio filename:</p>
                  <input
                    type="text"
          ...
          <div className="flex gap-4 pt-4">
            ...
            >
              {loading ? 'Adding...' : uploading ? 'Uploading...' : 'Add Word'}
            </button>
          </div>
        </form>
      </div>
